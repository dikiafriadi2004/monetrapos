  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(new Table({
      ...
      columns: [
        ...
        { name: 'role', type: 'enum', enum: ['super_admin', 'admin'], default: "'admin'", isNullable: false },
    ...
    if (!tableExists) {
      await queryRunner.createIndex('admin_users', new TableIndex({ name: 'idx_admin_users_is_active', columnNames: ['is_active'] }));
    }
  }
